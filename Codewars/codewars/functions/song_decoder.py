...
performance. Recently, he has decided to take a couple of old songs and make dubstep remixes
from them.

Let's assume that a song consists of some number of words. To make the dubstep remix of this song,
Polycarpus inserts a certain number of words "WUB" before the first word of the song (the number
may be zero), after the last word (the number may be zero), and between words (at least one
between any pair of neighbouring words), and then the boy glues together all the words,
...
print "1:["+song_decoder("AWUBBWUBC")+"]"
print "2:["+song_decoder("AWUBWUBWUBBWUBWUBWUBC")+"]"
print "3:["+song_decoder("WUBAWUBBWUBCWUB")+"]"
print "4:["+song_decoder("WUBWEWUBAREWUBWUBTHEWUBCHAMPIONSWUBMYWUBFRIENDWUB")+"]"
