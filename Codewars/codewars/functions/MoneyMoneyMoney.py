...
be kept in the bank in order for this sum of money to amount to 'D'.
...
def calculate_years(principal, interest, tax, desired):
    ...
    while current_amount < desired:
        interest_amount = current_amount * interest
        tax_amount = interest_amount * tax
        current_amount += (interest_amount - tax_amount)
        result += 1
    return result


print calculate_years(1000.00,.05,.18,1100.00)
